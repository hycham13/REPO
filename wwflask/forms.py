...
class CvForm(FlaskForm):
    ...
    computerskills = TextAreaField('Computerskills', validators=[DataRequired()],render_kw = {'placeholder':'entry all computer skills such as word,excel, programing language ...........etc'} )
    objective = TextAreaField('Objective', validators=[DataRequired()],render_kw = {'placeholder' : 'entry objective'})
